...
class VideoCategoryController extends Controller
{
    ...
    {
        //
        $rows = VideoCategory::orderBy('id', 'desc')->get();
    ...
    public function store(Request $request)
    {
        // Field Validation
        $request->validate([
            'title' => 'required|max:150|unique:video_categories,title',
    ...
    public function update(Request $request, $id)
    {
        // Field Validation
        $request->validate([
            'title' => 'required|max:150|unique:video_categories,title,'.$id,
            'meta_keyword' => 'max:500',
        ]);
